...
emojiImg = cv2.imread("/Users/benlerner/Desktop/computer_vision/facial-landmarks/images/emoji/Neutral_Face_Emoji.png", -1)
...
for (i, rect) in enumerate(rects):
    ...
    # configure emoji img
    emojiImg = imutils.resize(emojiImg, width=face_w, height=face_h)
    ...
    # TODO: hack
    roi_color = image[y:y+face_h+1, x:x+face_w]
